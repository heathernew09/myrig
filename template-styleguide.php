...
wp_rig()->print_styles( 'wp-rig-styleguide' );

?>

<div class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
  <div class="container-fluid d-flex align-items-center">
    <h1 class="d-flex align-items-center fs-4 text-white mb-0">
      <?php the_custom_logo(); ?>
      Styleguide
    </h1>
    <a href="../examples/styleguide-rtl/" class="ms-auto link-light" hreflang="ar">RTL cheatsheet</a>
  </div>
</div>
...
<div class="modal fade" id="exampleModalFullscreen" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      ...
      <script src="<?php echo get_site_url(); ?>/wp-content/themes/wprig/assets/js/styleguide.min.js"></script>
